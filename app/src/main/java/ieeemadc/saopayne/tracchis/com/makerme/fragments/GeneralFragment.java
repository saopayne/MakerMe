...
public class GeneralFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_general_news,container,false);

//        mSwipeLayout = (SwipeRefreshLayout)rootView.findViewById(R.id.general_news_swipe_refresh_layout);
//        mSwipeLayout.setColorSchemeResources(R.color.orange, R.color.blue, R.color.green, R.color.base_color);
        ...
        mListView = (ListView)rootView.findViewById(R.id.general_news_list);
