...
public class InterestFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_interest_news,container,false);

//        mSwipeLayout = (SwipeRefreshLayout)rootView.findViewById(R.id.interest_news_swipe_refresh_layout);
//        mSwipeLayout.setColorSchemeResources(R.color.orange, R.color.blue, R.color.green, R.color.base_color);
        ...
        mListView = (ListView)rootView.findViewById(R.id.interest_news_list);
        ...
        Document xmlFeed = rssfeed
                .getRSSFromServer("http://www.asktheadmin.com/feeds/posts/default?alt=rss");
